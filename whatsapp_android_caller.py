...
if __name__ == "__main__":
    ...
    #         with open("screen.png", "wb") as fp:
    #             fp.write(screenshot)
    #         img_gray = cv2.cvtColor(cv2.imread("screen.png"), cv2.COLOR_BGR2GRAY)[75:200,0:-1]
    ...
    #             # Step 3: Draw the rectangle on large_image
    #             cv2.rectangle(img_gray, (MPx,MPy),(MPx+tcols,MPy+trows),(255,255,255),2)
    #             # device.input_tap(MPx+tcols/2,MPy+trows/2)
    ...
    for device in devices:
        processes.append(Process(target = call_whatsapp, args = [device]))
